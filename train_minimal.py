...
def main():
    ...
    dset_train = data_minimal.load_from_textfile(train_file)
    dset_valid = data_minimal.load_from_textfile(val_file)

    tokenizer = data_minimal.train_bpe(dset_train, vocab_size=args.bpe_vocab_size, output_dir=args.tokenizer_dir,
    ...
    if args.resume:
        ...
        model.load_from_dir(os.path.join(args.output_dir, 'latest'), device)
